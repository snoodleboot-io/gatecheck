...
from gatecheck.config.workspace_spec import InheritMode


def effective_config(root: GatecheckConfig, package: GatecheckConfig) -> GatecheckConfig:
    ...
    return GatecheckConfig(hook=hooks, group=groups, sources=sources, package=package.package)


def _resolve_mode(root: GatecheckConfig, package: GatecheckConfig) -> InheritMode:
