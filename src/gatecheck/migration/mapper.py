"""Map a parsed pre-commit config onto gatecheck hooks (STY-0020 / GAT-23, STY-0032).
...
_KNOWN_REPOS: dict[str, _KnownRepo] = {
    ...
    # Node / system tools gatecheck cannot source from PyPI → system (must be on PATH).
    ...
    if known is not None:
        ...
        if known.source == "system":
            ...
            warnings.append(
                ...
                "PATH (gatecheck does not manage npm/system tools)"
            )
            return "system", run
