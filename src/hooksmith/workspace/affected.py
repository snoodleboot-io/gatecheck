"""Package graph + the affected set for ``hooksmith run --affected`` (STY-0018 / GAT-24).
...
from hooksmith.runner import HookResult, build_plan, route_files, run_plan
from hooksmith.workspace.inheritance import effective_config
from hooksmith.workspace.loader import DiscoveredPackage, Workspace
