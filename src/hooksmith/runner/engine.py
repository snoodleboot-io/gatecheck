...
Bridges the Python planner/executor and the native ``hooksmith_core.run_graph``
...
from hooksmith.core import core
from hooksmith.env import EnvManager
from hooksmith.runner.executor import run_hook
from hooksmith.runner.hook_result import HookResult
from hooksmith.runner.plan import ExecutionPlan
from hooksmith.runner.process_runner import ProcessRunner
...
def run_plan(
    ...
    *,
    ...
    ``hooksmith_core.run_graph``: each hook starts as soon as its dependencies finish
