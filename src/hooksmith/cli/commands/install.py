"""`hooksmith install` — install git hooks into the current repository."""
...
from hooksmith.install import InstallOutcome, has_on_event_groups, install_hooks
from hooksmith.runner import GitError


@click.command(help="Install hooksmith as the project's git hook runner.")
@click.option(
    "--config",
    "config_path",
