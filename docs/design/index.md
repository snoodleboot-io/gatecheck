...
These documents capture the design decisions behind gatecheck — both what was built and why alternatives were rejected.
...
<span style="font-size:.85rem;color:var(--md-default-fg-color--light)">Honest accounting of pre-commit's limitations and the specific problems gatecheck solves</span>
</div>
